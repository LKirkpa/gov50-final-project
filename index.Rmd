...
happ_mapp_data <- data.frame(
  country=WHDF2023$country,
  value=WHDF2023$happiness_score)
happ_mapp_cols <- colorRampPalette(brewer.pal(7,"YlOrRd"))(length(WHDF2023))
happ_mapp <- invisible(joinCountryData2Map(d, joinCode="NAME", nameJoinColumn="country"))
